...
export class Backend implements backendInterface {
    ...
    async sendImageMessage(arg0: string, arg1: string, arg2: Uint8Array): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendImageMessage(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateStatus(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateStatus(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
